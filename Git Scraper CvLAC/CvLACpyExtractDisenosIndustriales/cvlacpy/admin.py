...
class Admin(object):
    ...
    def LecturaCvlac(self, urlCvlac):
        ...
        for i, sec in enumerate( secciones[0:] ):
            ...
            elif nombreSec != None and nombreSec == "Diseño industrial":
                self.ProcesaSecDocTrabajos(sec, nombreInvestigador)

    def ProcesaSecDocTrabajos(self, sec,investigador):
        """
        Procesa la sección de Diseño industrial
        """
        # Contenedor con la información de cada Diseño industrial
        contInfo = sec.findAll("blockquote")
        # contenedor con el tipo del Diseño industrial
