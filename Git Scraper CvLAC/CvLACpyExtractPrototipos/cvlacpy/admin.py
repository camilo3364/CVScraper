...
class Admin(object):
    ...
    def LecturaCvlac(self, urlCvlac):
        ...
        for i, sec in enumerate( secciones[0:] ):
            ...
            elif nombreSec != None and nombreSec == "Prototipos":
                self.ProcesaSecPrototipos(sec, nombreInvestigador)

    def ProcesaSecPrototipos(self, sec,investigador):
        """
        Procesa la sección de Prototipos
        """
        # Contenedor con la información de cada Prototipo
        contInfo = sec.findAll("blockquote")
        # contenedor con el tipo del Prototipo
        ...
        for i in range(0, len(contInfo)):
            ...
            self.prototipo.append(libro)
        
    #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    def SavePrototipos(self,fname):
        """
        ...
        datos=[encabezado]+self.prototipo
