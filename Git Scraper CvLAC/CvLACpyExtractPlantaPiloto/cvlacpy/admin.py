...
class Admin(object):
    ...
    def LecturaCvlac(self, urlCvlac):
        ...
        for i, sec in enumerate( secciones[0:] ):
            ...
            elif nombreSec != None and nombreSec == "Planta piloto":
                self.ProcesaSecPlantaPiloto(sec, nombreInvestigador)

    def ProcesaSecPlantaPiloto(self, sec,investigador):
        """
        Procesa la sección de Planta piloto
        """
        # Contenedor con la información de cada Planta piloto
        contInfo = sec.findAll("blockquote")
        # contenedor con el tipo del Planta piloto
    ...
    #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    #%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    def SavePlantaPiloto(self,fname):
        """
